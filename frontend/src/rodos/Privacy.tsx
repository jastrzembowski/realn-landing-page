  ...
  return (
    ...
    <article className="rodos">
        ...
        <p>
          ...
          <a href="https://realn.pl/regulamin">Regulaminu Serwisu</a>, który
        ...
        <ul>
          <li>
            <p>
              Serwis - serwis internetowy "realn.pl" działający pod adresem
              https://realn.pl
            </p>
          </li>
          <li>
            <p>
              Serwis zewnętrzny - serwisy internetowe partnerów, usługodawców
          ...
          <li>
            <p>
              ...
              Administratorem Danych (dalej Administrator) jest firma "Realn
              Sp.zo.o", prowadząca działalność pod adresem: ul. Lęborska 3B ,
          ...
          <li>
            <p>
              ...
              możliwej do zidentyfikowania osobie fizycznej („osobie, której
              dane dotyczą”); możliwa do zidentyfikowania osoba fizyczna to
          ...
          <li>
            <p>
              ...
              zautomatyzowany lub niezautomatyzowany, taką jak zbieranie,
          ...
          <li>
            <p>
              Zgoda - zgoda osoby, której dane dotyczą oznacza dobrowolne,
              konkretne, świadome i jednoznaczne okazanie woli, którym osoba,
              której dane dotyczą, w formie oświadczenia lub wyraźnego działania
              potwierdzającego, przyzwala na przetwarzanie dotyczących jej
              danych osobowych
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              Pseudonimizacja - oznacza przetworzenie danych osobowych w taki
              sposób, by nie można ich było już przypisać konkretnej osobie,
              której dane dotyczą, bez użycia dodatkowych informacji, pod
              warunkiem że takie dodatkowe informacje są przechowywane osobno i
              są objęte środkami technicznymi i organizacyjnymi
          ...
          <li>
            <p>
              Anonimizacja - Anonimizacja danych to nieodwracalny proces
              operacji na danych, który niszczy / nadpisuje "dane osobowe"
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Skrypty Serwisów zewnętrznych, które mogą umieszczać pliki Cookies
              na Urządzeniach Użytkownika zostały świadomie umieszczone w
        ...
        <ul>
          <li>
            <p>
              ...
              Urządzenie Użytkownika wirusów, koni trojańskich oraz innych
              robaków jest także praktycznie niemożliwe.
            </p>
          </li>
          <li>
            <p>
              Cookie wewnętrzne - zastosowane przez Administratora pliki Cookie
              są bezpieczne dla Urządzeń Użytkowników i nie zawierają skryptów,
          ...
          <li>
            <p>
              Cookie zewnętrzne - Administrator dokonuje wszelkich możliwych
          ...
          <li>
            <p>
              ...
              dokonuje wszelkich starań, by przetwarzane dane osobowe
              wprowadzone dobrowolnie przez Użytkowników były bezpieczne, dostęp
              do nich był ograniczony i realizowany zgodnie z ich przeznaczeniem
              i celami przetwarzania. Administrator zapewnia także, że dokonuje
              wszelkich starań w celu zabezpieczenia posiadanych danych przed
              ich utratą, poprzez stosowanie odpowiednich zabezpieczeń
        ...
        <ul>
          <li>
            <p>Adres pocztowy - Realn Sp.zo.o, ul. Lęborska 3B </p>
          </li>
          <li>
            <p>Adres poczty elektronicznej - nieruchomosci@realn.pl</p>
          </li>
          <li>
