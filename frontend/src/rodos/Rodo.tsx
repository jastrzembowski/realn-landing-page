  ...
  return (
    <article className="rodos">
      ...
      <ul>
        ...
        <li>
          <strong>Serwis</strong> – serwis internetowych &quot;realn.pl&quot;,
          działających pod adresem https://realn.pl
        </li>
        <li>
          <strong>Usługodawca</strong> – firma &quot;Realn Sp.zo.o&quot; z
          adresem siedziby: ul.Lęborska 3B,{" "}
        </li>
        <li>
          <strong>Usługobiorca</strong> – każda osoba fizyczna, uzyskująca
          dostęp do Serwisu i korzystająca z usług świadczonych za pośrednictwem
          Serwisu przez Usługodawcę.
        </li>
        <li>
          <strong>Komunikacja Drogą Elektroniczną</strong> – Komunikacja
          pomiędzy stronami za pośrednictwem poczty elektronicznej (e-mail) oraz
      ...
      <ul>
        ...
        <li>
          ...
          zbiorem informacji i nie są kierowane do poszczególnych Usługobiorców.
          Usługodawca nie ponosi odpowiedzialności za wykorzystanie ich przez
          Usługobiorców.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          zaakceptować w całości jego postanowienia w celu dalszego korzystania
          z Serwisu.
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              podejmowania prób wgrywania lub wszczykiwania na serwer i do bazy
              danych kodu, skryptów i oprogramowania mogących śledzić lub
              wykradać dane Usługobiorców lub Usługodawcy,
            </li>
            <li>
              podejmowania jakichkolwiek działań mających na celu uszkodzenie,
              zablokowanie działania Serwisu lub uniemożliwienie realizacji celu
              w jakim działa Serwis.
            </li>
          </ul>
        </li>
        <li>
      ...
      <p>
        ...
        <a href="https://realn.pl/obowiazek-informacyjny-rodo/">
      ...
      <ul>
        ...
        <li>
          ...
          wyszukiwarki Google, Bing, Yahoo, NetSprint, DuckDuckGo, Facebook oraz
          LinkedIn jakichkolwiek artykułów, opisów, zdjęć oraz wszelkich innych
          treści, materiałów graficznych, wideo lub audio znajdujących się w
      ...
      <ul>
        <li>
          Usługodawca dokona wszelkich starań by usługi Serwisu były oferowane w
          sposób ciągły. Nie ponosi on jednak żadnej odpowiedzialności za
        ...
        <li>
          ...
          <ul>
            ...
            <li>Wysyłając wiadomość na adres e-mail: nieruchomosci@realn.pl</li>
          </ul>
